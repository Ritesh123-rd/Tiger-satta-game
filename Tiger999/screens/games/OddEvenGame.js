...
export default function OddEvenGame({ navigation, route }) {
    ...
    const handleSubmit = () => {
        ...
        Alert.alert('Success', `${selectedType} bet placed with ${points} points!`, [{ text: 'OK', onPress: () => { setPoints(''); } }]);
    };
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.content}>
                ...
                <View style={styles.oddEvenRow}>
                    <TouchableOpacity style={[styles.oddEvenButton, selectedType === 'ODD' && styles.oddEvenButtonActive]} onPress={() => setSelectedType('ODD')}>
                        <Text style={[styles.oddEvenText, selectedType === 'ODD' && styles.oddEvenTextActive]}>ODD</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={[styles.oddEvenButton, selectedType === 'EVEN' && styles.oddEvenButtonActive]} onPress={() => setSelectedType('EVEN')}>
                        <Text style={[styles.oddEvenText, selectedType === 'EVEN' && styles.oddEvenTextActive]}>EVEN</Text>
                    </TouchableOpacity>
                </View>
...
const styles = StyleSheet.create({
    ...
    oddEvenRow: { flexDirection: 'row', gap: 15, marginBottom: 20 },
    oddEvenButton: { flex: 1, paddingVertical: 18, borderRadius: 12, backgroundColor: '#fff', alignItems: 'center', borderWidth: 2, borderColor: '#E8E8E8' },
    oddEvenButtonActive: { backgroundColor: '#ca1835', borderColor: '#ca1835' },
    oddEvenText: { fontSize: 18, fontWeight: 'bold', color: '#333', fontFamily: 'RaleighStdDemi' },
    oddEvenTextActive: { color: '#fff' },
