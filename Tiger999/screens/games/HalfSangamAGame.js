...
export default function HalfSangamAGame({ navigation, route }) {
    ...
    const handleAddBid = () => {
        ...
        if (!closeAnk || closeAnk.length !== 1) { Alert.alert('Error', 'Please enter valid Close Ank (1 digit)'); return; }
        if (!points || parseInt(points) <= 0) { Alert.alert('Error', 'Please enter valid points'); return; }

        const newBid = {
            id: Date.now().toString(),
            sangam: `${openPana}-${closeAnk}`,
            points: points,
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.horizontalInputContainer}>
                    ...
                    <View style={styles.horizontalInputRow}>
                        <Text style={styles.horizontalLabel}>Enter Close Ank:</Text>
                        <TextInput style={styles.horizontalTextInput} placeholder="Ank" placeholderTextColor="#999" keyboardType="numeric" maxLength={1} value={closeAnk} onChangeText={setCloseAnk} />
                    </View>
