...
export default function HalfSangamBGame({ navigation, route }) {
    ...
    const handleAddBid = () => {
        if (!openAnk || openAnk.length !== 1) { Alert.alert('Error', 'Please enter valid Open Ank (1 digit)'); return; }
    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
                ...
                {/* Input Fields Row - Horizontal Style */}
                <View style={styles.horizontalInputContainer}>
                    <View style={styles.horizontalInputRow}>
                        <Text style={styles.horizontalLabel}>Enter Open Ank:</Text>
                        <TextInput style={styles.horizontalTextInput} placeholder="Ank" placeholderTextColor="#999" keyboardType="numeric" maxLength={1} value={openAnk} onChangeText={setOpenAnk} />
                    </View>
