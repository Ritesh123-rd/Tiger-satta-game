...
export default function RedJodiGame({ navigation, route }) {
    ...
    const handleSubmit = () => {
        if (!jodi || jodi.length !== 2) { Alert.alert('Error', 'Please enter valid jodi (2 digits)'); return; }
        if (!points || parseInt(points) <= 0) { Alert.alert('Error', 'Please enter valid points'); return; }
        Alert.alert('Success', `Red Jodi bet placed for ${jodi} with ${points} points!`, [{ text: 'OK', onPress: () => { setJodi(''); setPoints(''); } }]);
    };
        ...
        <View style={styles.container}>
            ...
            <ScrollView style={styles.content}>
                ...
                <View style={styles.inputGroup}>
                    ...
                    <TextInput style={styles.textInput} placeholder="00" placeholderTextColor="#999" keyboardType="numeric" maxLength={2} value={jodi} onChangeText={setJodi} />
                </View>
